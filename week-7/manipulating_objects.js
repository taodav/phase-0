...
The test I had the most trouble passing was setting carson as an object and also as a property 
of terah.children. I tried setting the children as separate variables, but in the end setting them
as properties of terah.children, then the property of name to each child worked.

How difficult was it to add and delete properties outside of the object itself?
It's honestly quite easy to add and delete properties outside of the object - 
to add all you have to do is add a dot after your object and your new property name, and set it equal
to your new property value.
to delete the property all you have to do is write delete before the name of the object with a dot and 
the property you want to delete.

What did you learn about manipulating objects in this challenge?
I learnt how to set properties within properties - something that wasn't taught on the eloquent javascript
book.
